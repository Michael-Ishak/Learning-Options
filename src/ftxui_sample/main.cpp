...
// configuration step. It creates a namespace called `Learning_Options`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Learning_Options::cmake::project_name, Learning_Options::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", Learning_Options::cmake::project_version);
      return EXIT_SUCCESS;
    }
